...
export default function KanbanPage() {
  ...
  // Drag and drop functions temporarily disabled
  /*
            ...
            <div>
                ...
                >
                  {lists.map((list, listIdx) => (
                    <div key={list.id}>
                        <div
                          className={`rounded-xl p-3 flex flex-col shadow-lg relative ${collapsedLists.has(list.id)
                              ? 'border-2'
                        ...
                        >
                          ...
                          {listDropdown.openId === list.id && (
                            <div 
                              ...
                              className={`absolute z-50 bg-neutral-900 border border-neutral-700 rounded-lg shadow-xl min-w-[280px] py-2 animate-fade-in dropdown-menu ${
                                collapsedLists.has(list.id) 
                                  ? 'left-full ml-2 top-16' // Lista recolhida - dropdown ao lado direito
                                  : 'right-3 top-14' // Lista expandida - dropdown logo abaixo do cabeçalho
                              }`}
                              role="menu"
